...
image::../images/angular-spring-boot/css-framework-tweet.png[CSS framework tweet, 500, scaledwidth="100%"]
...
[.text-center]
.Slightly styled
image::../images/angular-bootstrap/notes-default-style.png[Slightly styled, 800, scaledwidth="100%"]
