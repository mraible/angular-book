...
image::../images/angular-spring-boot/css-framework-tweet.png[CSS framework tweet, 500, scaledwidth="50%", align=center]
...
.Navbar squished
image::../images/angular-bootstrap/navbar-squished.png[Navbar squished, 600, scaledwidth="70%", align=center]
...
image::../images/angular-bootstrap/notes-menu.png[Squished navbar with menu, 600, scaledwidth="70%", align=center]
