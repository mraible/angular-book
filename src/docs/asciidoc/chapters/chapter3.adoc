...
image::../images/angular-bootstrap/angular-bootstrap.png[Beautiful Angular 😍, 800, scaledwidth="100%", align=center]
...
[link=https://twitter.com/mraible/status/1196894737870938113]
image::../images/angular-spring-boot/css-framework-tweet.png[CSS framework tweet, 500, scaledwidth="100%", align=center]
...
CAUTION: If you get an error when running `npm install`, delete `node_modules` and `package-lock.json` and try again.
...
[CAUTION]
====
The current release (v11.0.0) doesn't install Bootstrap 5 by default, so install it:

----
npm i bootstrap@5
----

If NG Bootstrap v12 has been https://github.com/ng-bootstrap/ng-bootstrap/releases[released], you don't need to do this step.
====
...
.Bare-bones styling
image::../images/angular-bootstrap/notes-bare-bones.png[Bare-bones styling, 800, scaledwidth="100%", align=center]

Let's fix that!

.Security Configuration
****
Both app's should have their security configured to use OIDC from the last chapter. If you need to configure security for them, you can use the Okta CLI.
...
.Slightly styled
image::../images/angular-bootstrap/notes-default-style.png[Slightly styled, 800, scaledwidth="100%", align=center]

Enter a note and you'll see it in the list.

.First note
image::../images/angular-bootstrap/first-note.png[First note, 800, scaledwidth="100%", align=center]
...
To demonstrate how you can override Bootstrap's variables, create a `src/_variables.scss` and override the colors. You can see the https://github.com/twbs/bootstrap/blob/v5.1.3/scss/_variables.scss[default variables in Bootstrap's GitHub repo].
...
image::../images/angular-bootstrap/bootstrap-sass.png[Customized Bootstrap variables, 800, scaledwidth="100%", align=center]
...
You can see from the screenshots above that `angular-crud` generates screens with some styling, but it's not quite right. Let's start by adding a https://getbootstrap.com/docs/5.1/components/navbar/[Navbar] in `app.component.html`. Change its HTML to have a collapsible navbar (for mobile devices), add links to useful sites, and add login/logout buttons. While you're at it, display a message to the user when they aren't authenticated.
...
<div class="container-fluid pt-3">
  <a *ngIf="!(authService.authState$ | async)?.isAuthenticated">Please log in to manage your notes.</a>
  <router-outlet></router-outlet>
</div>
----
...
image::../images/angular-bootstrap/notes-with-navbar.png[Notes app with navbar, 800, scaledwidth="100%", align=center]
...
.Navbar squished
image::../images/angular-bootstrap/navbar-squished.png[Navbar squished, 600, scaledwidth="100%", align=center]
...
image::../images/angular-bootstrap/notes-menu.png[Squished navbar with menu, 600, scaledwidth="100%", align=center]
...
.Styled Notes Form
image::../images/angular-bootstrap/styled-notes-form.png[Styled Notes Form, 800, scaledwidth="100%", align=center]
...
.Title is required
image::../images/angular-bootstrap/notes-edit-required-title.png[Title is required, 800, scaledwidth="100%", align=center]

If you give it focus and leave, it'll add a red border around the field.

.Dirty title validation decoration
image::../images/angular-bootstrap/notes-edit-red-outline.png[Dirty title validation decoration, 800, scaledwidth="100%", align=center]
...
// todo: ng-bootstrap link above fails to load website from IDEA, check PDF
...
_Make sure to replace `<your username>` with the email address you use to log in to Okta._
...
image::../images/angular-bootstrap/notes-list-with-sorting.png[Notes list with sorting, 800, scaledwidth="100%", align=center]
...
image::../images/angular-bootstrap/notes-list-with-pagination.png[Notes with pagination, 800, scaledwidth="100%", align=center]
...
.KHipster Notes
image::../images/angular-bootstrap/khipster-notes.png[KHipster Notes, 800, scaledwidth="100%", align=center]
