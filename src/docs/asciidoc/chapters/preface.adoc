...
I've been developing websites and web applications since the 1990s. Along the way, I've become a web framework aficionado. I appreciate web frameworks because of their patterns, the testability they offer, and the flourishing communities that tend to sprout up around them.
...
I wanted to write this book because I think Angular and Spring Boot are among the most powerful combinations for writing web apps today. You can use JHipster to generate an app with both frameworks, but if you really want to learn how something works, it's important to learn the building blocks.
