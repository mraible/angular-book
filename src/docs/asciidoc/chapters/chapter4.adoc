...
image::../images/angular-deployment/idea-env-variables.png[IntelliJ Environment Variables, 600, scaledwidth="100%", align=center]
====
...
.Netlify create site
image::../images/angular-deployment/netlify-create-site.png[Netlify create site, 650, scaledwidth="100%", align=center]
