...
[.avatar-row]
https://twitter.com/bsautel[image:../images/angular-docker/bsautel.jpg[alt=Benoit Sautel,role="BlogPost-avatar img-100px"]]
https://twitter.com/saturnism[image:../images/angular-docker/saturnism.jpg[alt=Ray Tsang,role="BlogPost-avatar img-100px"]]
https://twitter.com/_JamesWard[image:../images/angular-docker/_JamesWard.jpg[alt=James Ward,role="BlogPost-avatar img-100px"]]
https://twitter.com/starbuxman[image:../images/angular-docker/starbuxman.jpg[alt=Josh Long,role="BlogPost-avatar img-100px"]]
https://twitter.com/codefinger[image:../images/angular-docker/codefinger.jpg[alt=Joe Kutner,role="BlogPost-avatar img-100px"]]
====
////
...
If you'd rather start from this point, download the `source.zip` for this book from InfoQ. The `angular-deployment` directory has the previous sections's completed example. Copy it to `angular-docker` in your favorite code location.
...
== Heroku with Spring Boot + Docker
...
// proposal: Download the `source.zip` for this book from InfoQ. The `angular-docker` directory has this sections completed example.
