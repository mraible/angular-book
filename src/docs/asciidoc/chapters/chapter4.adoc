...
== Cloud Foundry with Spring Boot + Docker
...
image::../images/angular-docker/cloud-foundry-works.png[Angular + Spring Boot in Docker running on Pivotal Web Services, 800, scaledwidth="100%"]
