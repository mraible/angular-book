...
[big red yellow-background]*TODO: <Deepu:Suggestion>: Might be slightly confusing to talk about folders from 2 chapters, may be just mentioning angular-bootstrap from previous chapter in above para would be cleaner*
...
[big red yellow-background]*TODO: <Deepu:Suggestion>: Is an OKta account prerequisite here or is it automatically created? If not how do you authenticate?*
