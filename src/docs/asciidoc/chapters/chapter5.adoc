...
image::../images/angular-docker/angular-docker-spring-boot-hug.png[Angular + Docker with a Big Hug from Spring Boot, 800, scaledwidth="100%", align=center]
...
image::../images/angular-docker/first-note-on-heroku.png[First Note on Heroku, 800, scaledwidth="100%", align=center]
...
image::../images/angular-docker/angular-docker-securityheaders.png[Nginx in Docker score from securityheaders.com, 800, scaledwidth="100%", align=center]
...
[source,shell]
----
docker tag mraible/bootiful-angular registry.heroku.com/quiet-shelf-06130/web
docker push registry.heroku.com/quiet-shelf-06130/web
heroku container:release web --remote jib
----
...
image::../images/angular-docker/heroku-jib-headers-a.png[A Security Headers with Jib, 800, scaledwidth="100%", align=center]
...
----
kubectl apply -f \
 https://github.com/knative/serving/releases/download/knative-v1.0.0/serving-crds.yaml
...
kubectl apply -l knative.dev/crd-install=true -f \
 https://github.com/knative/net-istio/releases/download/knative-v1.0.0/istio.yaml
kubectl apply -f \
 https://github.com/knative/net-istio/releases/download/knative-v1.0.0/istio.yaml
...
----
kubectl apply -f \
 https://github.com/knative/serving/releases/download/knative-v1.0.0/serving-default-domain.yaml
----
...
----
kubectl apply -f \
 https://github.com/knative/net-certmanager/releases/download/knative-v1.0.0/release.yaml
----
...
----
NAME               URL
bootiful-angular   https://bootiful-angular.default.35.232.41.220.sslip.io
----
...
- Sign-in: `\https://bootiful-angular.default.35.232.41.220.sslip.io/login/oauth2/code/okta`
- Sign-out: `\https://bootiful-angular.default.35.232.41.220.sslip.io`
...
image::../images/angular-docker/knative-works.png[Angular + Spring Boot in Docker running on Knative, 800, scaledwidth="100%", align=center]
...
.Spring Boot 2.5 app running
image::../images/angular-docker/spring-boot-2.5-notes.png[Spring Boot 2.5 app running, 800, scaledwidth="100%", align=center]
