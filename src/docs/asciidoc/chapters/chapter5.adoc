...
Remove Okta's Angular SDKs and OktaDev Schematics from your Angular project.
...
// todo: update above YAML to Knative 1.0
...
- Sign-in redirect: `\https://bootiful-angular.default.35.232.41.220.nip.io/login/oauth2/code/okta`
- Sign-out redirect: `\https://bootiful-angular.default.35.232.41.220.nip.io`
...
[[spring-boot-2.5-notes]]
.Spring Boot 2.5 app running
image::../images/angular-docker/spring-boot-2.5-notes.png[Spring Boot 2.5 app running, 800, scaledwidth="100%"]
