...
You can use the https://github.com/briebug/cypress-schematic[Cypress Angular Schematic] to add Cypress to your Angular project.

----
ng add @briebug/cypress-schematic
----

This will add Cypress as a dependency and create configuration files to work with Angular and TypeScript. Modify `cypress/integration/spec.ts` to look for the title of your app.
...
If you click on the file name or "Run 1 integration test spec", it'll launch a browser and run the test. You can use this feature to step through your tests, find selectors for elements, and much more.

// https://armno.in.th/2020/02/26/cypress-angular-integration-testing/

Personally, I prefer the Protractor experience where you could just run the command, it'd run all the tests, and no interaction is required from the user. You can do this with Cypress too!
...
And, run the Cypress tests for it in another window:

----
npm run e2e
----

TIP: You might notice a video is created. You can disable this by adding `"video": false` to your `cypress.json` file.
...
[[protractor-success]]
.Protractor success
image::../images/ng-demo/protractor-success.png[Protractor success, 800, scaledwidth="100%"]
...
----
ng add @ng-bootstrap/ng-bootstrap@7
----
...
// todo: show all changes necessary to templates
// copy images from ng-demo into this project
...
.OIDC App Settings
image::../images/ng-demo/oidc-settings.png[OIDC App Settings, 730, scaledwidth="100%"]
...
I created a GitHub repo with all of the code from this chapter. You can find it on GitHub in the https://github.com/mraible/ng-demo[mraible/ng-demo repository].
