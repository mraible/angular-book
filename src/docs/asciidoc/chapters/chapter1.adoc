  ...
  build:
    ...
    steps:
      ...
      - name: Run integration tests
        run: xvfb-run --server-args="-screen 0 1024x768x24" --auto-servernum npm start && npm run cypress:run
----
