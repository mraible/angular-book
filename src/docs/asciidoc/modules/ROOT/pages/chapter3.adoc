...
image::angular-spring-boot/css-framework-tweet.png[CSS framework tweet, 500, scaledwidth="50%", align=center]

// todo: update to use https://twitter.com/mraible/status/1643925994015981568
...
# Copy the results of this command into notes-api/.okta.env
----
