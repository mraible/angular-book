...
You might think that Angular Material is more popular than Bootstrap these days. You may be right, but who you follow on Twitter shapes your popularity perspective. Bootstrap and Angular Material were quite popular among the fabulous folks that answered my recent poll. https://twitter.com/mraible/status/1196894737870938113[In 2019]; 53% answered Bootstrap, and 33% answered Angular Material.
