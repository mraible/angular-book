...
If you test your new Netlify site on https://securityheaders.com/[securityheaders.com], you'll score a **D**. To improve your score, Netlify allows you to add https://docs.netlify.com/routing/headers/[custom headers].
