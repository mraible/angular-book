...
You might notice that the `EditComponent` could use some additional coverage. If you need to improve this coverage, please create a pull request!
...
At the time of this writing, Angular CLI had no continuous integration support. This section shows you how to set up continuous integration with https://github.com/features/actions[GitHub Actions] and https://jenkins.io/[Jenkins].
